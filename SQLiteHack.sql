...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(datasrc_id)'
WHERE name='data_src';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(ndb_no, nutr_no, datasrc_id)'
WHERE name='datsrcln';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(deriv_cd)'
WHERE name='deriv_cd';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(fdgrp_cd)'
WHERE name='fd_group';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(ndb_no)'
WHERE name='food_des';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(factor_code)'
WHERE name='langdesc';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(ndb_no, factor_code)'
WHERE name='langual';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(ndb_no, nutr_no)'
WHERE name='nut_data';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(nutr_no)'
WHERE name='nutr_def';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(src_cd)'
WHERE name='src_cd';
COMMIT;
#
BEGIN;
...
UPDATE sqlite_master SET sql= SUBSTRING(sql, 1, LENGTH (sql) - 1) || ', primary key(ndb_no, seq)'
WHERE name='weight';
COMMIT;
